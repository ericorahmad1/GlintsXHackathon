          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Sort Candidate</a></li>
                <li class="nav-item"><a class="nav-link" href="#" data-toggle="tab">Have company candidate</a></li>
                <li class="nav-item"><a class="nav-link" href="#" data-toggle="tab">Engaged with your talent brand</a></li>
              </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
